...
st.set_page_config(page_title="R.A.A.T Web V4",
    page_icon="./img/favicon.png",
    layout="wide"
    )

st.markdown("<h1 style='text-align: center;'>R.A.A.T Web V4</h1>", unsafe_allow_html=True)
